    ...
    def download(self):
        ...
        try:
            ...
            if "downloadQuotaExceeded" in err:
                ...
                err = "This Google Drive file/folder is private and cannot be accessed. Please make sure the file is public or you have proper permissions."
            elif (
                "403" in err
                or "Forbidden" in err
                or "insufficientFilePermissions" in err
            ):
                err = "Access denied. This Google Drive file/folder is private. Please make the file public or check your permissions."
